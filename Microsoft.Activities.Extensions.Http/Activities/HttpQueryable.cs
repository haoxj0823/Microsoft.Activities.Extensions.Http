...
namespace Microsoft.Activities.Http.Activities
{
    ...
    public sealed class HttpQueryable<T> : NativeActivity
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HttpQueryable{T}"/> class. 
        /// </summary>
        public HttpQueryable()
        {
            // this.Body = new ActivityFunc<HttpRequestMessage, IDictionary<string, string>, IQueryable<T>>();
        }
        ...
        /// </summary>
        [DefaultValue(null)]
        public ActivityFunc<HttpRequestMessage, IDictionary<string, string>, IQueryable<T>> Body { get; set; }
        ...
        {
            if (request.Headers.Accept.Contains(new MediaTypeWithQualityHeaderValue(MediaTypes.JsonMediaType)) || request.Headers.Accept.Contains(new MediaTypeWithQualityHeaderValue(MediaTypes.JsonTextMediaType)))
            {
                return new MediaTypeWithQualityHeaderValue(MediaTypes.JsonMediaType);
            }

            return new MediaTypeWithQualityHeaderValue(MediaTypes.XmlMediaType);
        }
