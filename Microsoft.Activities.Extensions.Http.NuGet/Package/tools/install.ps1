...
#remove the designer
$ref = $project.Object.References.Find("Microsoft.Activities.Extensions.Http.Design")
if ($ref) {	$ref.Remove() }

Import-Module(join-path $toolsPath "Microsoft.Activities.Extensions.Http.NuGet.dll")

Add-ActivityToolbox -Project $project.Object -Activity "Microsoft.Activities.Http.Activities.HttpWorkflowService" -Category "Microsoft.Activities.Http.Activities" -ActivityAssembly "Microsoft.Activities.Extensions.Http" -BitmapID "HttpReceive"
Add-ActivityToolbox -Project $project.Object -Activity "Microsoft.Activities.Http.Activities.HttpReceive" -Category "Microsoft.Activities.Http.Activities" -ActivityAssembly "Microsoft.Activities.Extensions.Http" -BitmapID "HttpReceive"
Add-ActivityToolbox -Project $project.Object -Activity "Microsoft.Activities.Http.Activities.HttpQueryable" -Category "Microsoft.Activities.Http.Activities" -ActivityAssembly "Microsoft.Activities.Extensions.Http" -BitmapID "HttpReceive"


Add-ActivityToolbox -Project $project.Object -Activity "Microsoft.Activities.Http.Activities.CheckIfMatch" -Category "Microsoft.Activities.Http.Activities" -ActivityAssembly "Microsoft.Activities.Extensions.Http" -BitmapID "HttpReceive"
